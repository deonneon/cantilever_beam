...
# Train the Model
history = model.fit(X_train, y_train, validation_data=(X_validation, y_validation), epochs=20, batch_size=5)
...
# If the validation loss starts increasing or remains much higher than the training loss, 
